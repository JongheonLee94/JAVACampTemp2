...
<script>
	window.onload(){
		...
		var op=doucment.getElementById("btn");
		var dv=document.getElementById("dv");
		var dv2=document.getElementById("dv2");
		op.onclick=function(){
				if(log.email.value=''){
					alert('이메일을 입력해주세요.');
				}else if(log.pw.value=''){
					alert('비밀번호를 입력해주세요');
				}else
					log.submit();
		}
...
<div id="section-1"class="container">
	...
	<div class="card bg-light">
		...
		<div style="text-align:center"><a href="login_member.jsp">회원 로그인 </a><a href="login_guest.jsp">게스트 로그인</a></div>
		
			<h4 class="card-title mt-3 text-center">회원 로그인</h4>
			<br>
			...
			<div id="section-1" class="container">
				<div class="row">
					<div class="loginSection">
						...
						<form id ="log" class="form-signin" method="post" action="../login_member.do">
														
								<input type="text" class="form-control" name="email" placeholder="ID" required autofocus>
